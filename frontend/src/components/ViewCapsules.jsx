...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .badge-locked { background: rgba(252,220,225,0.4); color: #c48a9e; border: 1px solid rgba(252,220,225,0.6); }
  .badge-open { background: rgba(200,206,238,0.4); color: #6b72a8; border: 1px solid rgba(200,206,238,0.5); }
  ...
  .open-hint { font-size: 11.5px; color: #c4b8d8; font-style: italic; }
  .card-arrow { color: #d8bee5; font-size: 18px; transition: transform 0.2s; }
  ...
  .chip-label { font-size: 10px; letter-spacing: 0.1em; text-transform: uppercase; color: #c4b8d8; margin-bottom: 4px; }
  .chip-value { font-size: 13px; color: #4a3f6b; font-weight: 500; }
